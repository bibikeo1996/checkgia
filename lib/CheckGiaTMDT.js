...
function CheckGiaTMDT(req,res){
    ...
    for (var doithu of urls) {
        try {
            await page.goto("https://shopee.vn/search?keyword="+doithu.Name+"&locations=TP.%2520H%25E1%25BB%2593%2520Ch%25C3%25AD%2520Minh&noCorrection=true&order=asc&page=0&sortBy=price", {waitUntil: 'networkidle2', timeout: 100000});
